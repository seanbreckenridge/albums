...
This is a personal project of mine, but I thought I'd leave these files up here in case anyone wanted to use them. This is pretty old project and the python/generation process its pretty scattered (see `update`), but the CSV/SQL files are very usable.

See [`src`](./src/) for CSV and [`SQL`](./SQL/) for the sources/data

![](./SQL/images/diagram.png)
